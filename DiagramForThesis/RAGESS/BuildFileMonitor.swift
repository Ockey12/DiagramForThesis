...
class BuildFileMonitor: ObservableObject {
    @Published private var convertedStructHolders: [ConvertedToStringStructHolder] = [ConvertedToStringStructHolder]()
    @Published private var convertedClassHolders: [ConvertedToStringClassHolder] = [ConvertedToStringClassHolder]()
    @Published private var convertedEnumHolders: [ConvertedToStringEnumHolder] = [ConvertedToStringEnumHolder]()
    @Published private var convertedProtocolHolders: [ConvertedToStringProtocolHolder] = [ConvertedToStringProtocolHolder]()
    @Published private var dependenceHolders: [DependenceHolder] = [DependenceHolder]()
    @Published private var changeDate: String = ""
    
    private var allTypeNames: [String] = [String]()
    
    private var monitoredFolderFileDescriptor: CInt = -1
    private let folderMonitorQueue: DispatchQueue = DispatchQueue(label: "BuildFileMonitorQueue", attributes: .concurrent)
